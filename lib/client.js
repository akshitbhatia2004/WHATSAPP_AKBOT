...
try {
    ...
    console.log("🌍 Connected to the whtasapp_akbot DB")
} catch {
...
`.trim());
                ...
                console.log(e)
             //   await Void.sendMessage('919971606684@s.whatsapp.net',{text: util.format(mek)})
...
app.listen(port, () => console.log(`whatsapp_akbot Server listening on port http://localhost:${port}!`));
